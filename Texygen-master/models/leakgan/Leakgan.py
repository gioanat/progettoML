...
class Leakgan(Gan):
    def __init__(self, oracle=None):
        ...
        FLAGS = flags.FLAGS
        flags.DEFINE_boolean('g', True, 'tipo_gan')
        flags.DEFINE_boolean('t', True, 'tipo')
        flags.DEFINE_boolean('d', True, 'data')
        ...
        self.oracle_file = 'save/oracleLEAKGAN.txt'
        self.generator_file = 'save/generatorLEAKGAN.txt'
        self.test_file = 'save/test_fileLEAKGAN.txt'
    ...
    def init_oracle_trainng(self, oracle=None):
        ...
        self.sess = tf.compat.v1.Session(config=config) #tf.Session(config=config)
