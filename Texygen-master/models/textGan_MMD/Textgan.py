...
class TextganMmd(Gan):
    def __init__(self, oracle=None):
        ...
        self.oracle_file = 'save/oracleTEXTGAN.txt'
        self.generator_file = 'save/generatorTEXTGAN.txt'
        self.test_file = 'save/test_fileTEXTGAN.txt'
    ...
    def init_oracle_trainng(self, oracle=None):
        ...
        g_embeddings = tf.Variable(tf.compat.v1.random_normal(shape=[self.vocab_size, self.emb_dim], stddev=0.1))
        discriminator = Discriminator(sequence_length=self.sequence_length, num_classes=2,
                                      ...
                                      l2_reg_lambda=self.l2_reg_lambda, dropout_keep_prob=0.95)
