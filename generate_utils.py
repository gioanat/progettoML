...
def traslated_funct(text):
    ...
    for el in broken_sent:
      words1=""
      batch = tokenizerTrasl.prepare_seq2seq_batch(src_texts=[el],return_tensors='pt') 
      gen = modelTrasl.generate(**batch) 
      words: List[str] = tokenizerTrasl.batch_decode(gen, skip_special_tokens=True)
      for el in words:
        words1=words1+el
